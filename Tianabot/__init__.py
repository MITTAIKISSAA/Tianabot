...
if ENV:
    ...
    START_IMG = os.environ.get("START_IMG", "https://telegra.ph//file/311b2f9eb8590122838b4.jpg")
    ...
    UPDATE_CHANNEL = os.environ.get("UPDATE_CHANNEL", "SHIELDUPDATE")
    ...
    SUPPORT_CHAT = os.environ.get("SUPPORT_CHAT", "SHEILDSUPPORT")
